...
@pytest.mark.asyncio
async def test_user_insert_get(db_session: AsyncSession, redis_client: Redis):
...
@pytest.mark.asyncio
async def test_user_insert_delete_get(db_session: AsyncSession, redis_client: Redis):
    async with db_session as session:
        async with redis_client as client:
            repository = PostgresCacheRepository(
                _session=session,
...
@pytest.mark.asyncio
async def test_user_insert_gets(db_session: AsyncSession, redis_client: Redis):
    async with db_session as session:
        async with redis_client as client:
            repository = PostgresCacheRepository(
                _session=session,
